...
hl = HomoLogic(reference_fasta="Ort-RDM-1_3.fasta", reference_pdb="Ort-RDM-1_3.pdb", reference_ligands_pdb="Ort-RDM-1_3_ligands.pdb", homologs_fasta="Ssal-KRED_ortholog_library_sequences.fasta")
...
hl.generate_boltz_input(smiles_code=["C1C=CN(C=C1C(=O)N)[C@H]2[C@@H]([C@@H]([C@H](O2)COP(=O)(O)OP(=O)(O)OC[C@@H]3[C@H]([C@H]([C@@H](O3)N4C=NC5=C(N=CN=C54)N)OP(=O)(O)O)O)O)O","CC(=O)C1=CC=CC=C1"], output_folder='02_boltz_input')
...
hl.analyze_reference_cavity_properties(input='Ort-RDM-1_3_bindingsite.pdb', output_results_folder='reference_cavity_analysis', probe_out=4.0, volume_cutoff=100.0)

# And finally, detect cavities analyze their properties
hl.analyze_cavity_properties(input_folder='08_homolog_bindingsites_superposed', output_cavities_folder='11_detected_cavities', reference_pdb='Ort-RDM-1_3_bindingsite.pdb', output_results_folder='12_cavity_analysis_results', probe_out=4.0, volume_cutoff=100.0, csv_input='10_bindingsite_similarity_results/bindingsite_homology.csv')