...
ax_left.set_ylabel("(S)     ee 5b (%)     (R)", fontsize=18, fontweight='bold', color='black')
...
if second_col:
    ...
    ax_right.set_ylabel("Product formation 5b (S) [mM]", fontsize=18, fontweight='bold', color='black')
